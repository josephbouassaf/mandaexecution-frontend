...
const LandingPage = () => {
    return (
        <Flex direction={'column'} gap={2}>
            <LandingPageSection button={<Button mt={4} bg={'black'} color={'white'} borderRadius={'full'} boxShadow={'xl'}> <Link href={'/'}>Launch App</Link></Button>}imagePath="/game_of_life_simple.gif" title="Enabling Collective Treasury Management" description="For protocols, DAOs, and ecosystem players,
